        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Card className="p-8 prose dark:prose-invert max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Digital Service Delivery</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Service Delivery</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Delivery Time</h2>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Important Note</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
