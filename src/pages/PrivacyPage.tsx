      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Card className="p-8 prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">3. Data Storage</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                All data is securely stored on servers hosted in secure data centers.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">4. Payment Information</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">5. Cookies</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">6. Sharing of Data</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">7. Data Security</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">8. Your Rights</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">9. Contact</h2>
              <p className="text-gray-600 dark:text-gray-400">
