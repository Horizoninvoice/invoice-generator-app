  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl font-bold text-black dark:text-gray-100 mb-8">Subscription Management</h1>
        ...
        {profile && (
          <Card className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-black dark:text-gray-100 mb-2">Current Plan</h3>
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <h3 className="text-2xl font-bold text-black dark:text-gray-100">{plan.name}</h3>
                </div>
                <div className="mb-4">
        ...
        <Card>
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-black dark:text-gray-100 mb-2">Need a Custom Solution?</h3>
