        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Card>
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-black dark:text-gray-100 mb-2">Reports & Analytics</h2>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-black dark:text-gray-100">Reports & Analytics</h1>
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-black dark:text-gray-100">{reports.totalInvoices}</p>
              </div>
              ...
              <div className="space-y-4">
                {reports.topCustomers.map((customer, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded">
                    <div>
                      <p className="font-medium text-black dark:text-gray-100">{customer.name}</p>
