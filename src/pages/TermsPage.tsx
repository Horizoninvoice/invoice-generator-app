        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Card className="p-8 prose dark:prose-invert max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">1. About the Service</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">2. Eligibility</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">4. Subscription & Payments</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">5. Refund Policy</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">6. Usage Restrictions</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">7. Intellectual Property</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">8. Termination</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">9. Governing Law</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">10. Contact</h2>
              <p className="text-gray-600 dark:text-gray-400">
