                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      />
                      <label htmlFor="enable-notes" className="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
                        Notes
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <input
                        ...
                        className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="enable-terms" className="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
                        Terms & Conditions
                        <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <input
                        ...
                        className="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="enable-footer" className="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
                        Footer Message
                        <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
